#ifndef _NOPARKINGABILITY_H_
#define _NOPARKINGABILITY_H_
...
class SN_DLL_API NoParkingAbility
{
public:
	NoParkingAbility();
	~NoParkingAbility();
	NoParkingAbility& operator=(const NoParkingAbility& p_objNoParkingAbility);
    /***********************************************************************
	*	概述：设置提供非法停车（NoParking）功能的智能库的ID
	*	输入：
	*		p_nLibId ：智能库ID
	*	输出：
	*		无
	...
	************************************************************************/
    ...
    /***********************************************************************
	*	概述：获取提供非法停车（NoParking）功能的智能库的ID
	*	输入：
	*		无
	*	输出：
	*		无
