...
#include "AVDataStruct.h"
	...
	typedef long long			INT64;
		...
		#define AVDATAEX_API __declspec(dllexport)
	#else
		#define AVDATAEX_API __declspec(dllimport)
	#endif
#else
	#define AVDATAEX_API
#endif
...
// 	bool setData(const char *p_pszData, const unsigned int p_nDataLength);
	...
	/*******************************yuganTest*********************************/
	/*******************************yuganTest*********************************/
	bool setData(const std::vector<DataInfo>& p_objAVDataStructEXList);

	const std::vector<DataInfo> getData()const;
	
	const int getDataLength()const;

	const int getCurrentData(const int p_nPos, unsigned char*& p_szCurrentData, int& p_nIndex)const;
	...
	*		设置帧数据。
	**************************************************************************/
	bool copyData(const AVDataEX& p_objAVDataEX);
	...
	*		获得帧数据长度。
	**************************************************************************/
	const int getDataLengthEX() const;
...
private:
	...
	std::vector<DataInfo> m_objAVDataStructEXList;
}_PACKED_1_;
