...
public:
	...
	*		设置云台巡游的备注名
    **输入：
	*	  p_pszTourName ：云台预制点的名字，字符串，最大长度
	...
	*		false：失败
	*功能：
	*    若输入p_pszTourName长度<=CONST_MAXLENGTH_PTZ_TOUR_NAME，返回true，并保存到m_szProtocolName;
	...
	*		false：不相等
	**功能：
	*		两个PTZTour类的对象，所有属性均相等，则说明这两个对象相等，返回true
	*		如果有一个属性不等，则返回false。
	*****************************************************************************/
