#ifndef _PERIMETERABILITY_H_
#define _PERIMETERABILITY_H_
...
class SN_DLL_API PerimeterAbility
{
public:
	PerimeterAbility();
	~PerimeterAbility();
	PerimeterAbility& operator=(const PerimeterAbility& p_objPerimeterAbility);
    /***********************************************************************
	*	概述：设置提供周界入侵（Perimeter）功能的智能库的ID
	*	输入：
	*		p_nLibId ：智能库ID
	*	输出：
	*		无
	...
	************************************************************************/
    ...
    /***********************************************************************
	*	概述：获取提供周界入侵（Perimeter）功能的智能库的ID
	*	输入：
	*		无
	*	输出：
	*		无
	...
	*	概述：设置限定目标大小的单位
	*	输入：
	*		p_pTargetSizeConstrainUnit ：限定目标大小的单位
	*	输出：
	*		无
	*	返回值：
	*		
