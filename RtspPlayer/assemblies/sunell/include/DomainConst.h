...
#define CONST_MAXLENGTH_DN								256		//DNS长度
#define CONST_MAX_CHANNEL_NAME							48		//通道名称
...
#define CONST_MAXLENGTH_USERPASSWORD					20		//用户密码长度
...
#define CONST_MAXLENGTH_SN                              32      //SN序列号
...
#define CONST_MAXLENGTH_PTZ_TRACE_NAME					32      //云台轨迹S2V1的名字长度
...
#define CONST_MAXLENGTH_LOG_PARAM_DATA					512		//日志信息详细参数最大长度
...
#define CONST_OSD_FONT_DESCRIPTION						16		//OSD字体长度
...
#define CONST_MAXLENGTH_SSID							128		//热点SSID长度
#define CONST_MAXLENGTH_SSID_PASSWORD					128		//热点SSID密码长度
...
#define CONST_MAXLENGTH_FILESYSTEM_NAME					32		//文件系统名字长度
#define CONST_MAXLENGTH_DETECTIONAREA_NAME				32		//移动侦测区域名称长度
#define CONST_MAXLENGTH_DISKATTRIBUTE_NAME				32		//磁盘属性名字长度
#define CONST_MAXLENGTH_LAYOUT_NAME						128		//布局名字长度
#define CONST_MAXLENGTH_CMS_REGISTER_SRV_NAME			32		//CMS注册服务器名字长度
#define CONST_MAXLENGTH_EXTERN_CONFIG_NAME				32		//CMS扩展配置名字长度


#define CONST_NETWORK_CARD_NAME							32		//网卡命名
#define CONST_NETWORK_CARD_DESCRIPTION					64		//网卡描述
#define CONST_MAXLENGTH_CHANNEL_NAME					64		//通道名称长度	

#define CONST_STATE_STREAM								1		//不支持伴随流的原始流
#define CONST_STATE_WITH_SVC_STREAM						2		//支持伴随流的原始流
#define CONST_SVC_STREAM								3		//伴随流

#define	CONST_TAGET_TYPE_UNKNOWN									0
#define CONST_TAGET_TYPE_HUMAN										1
#define CONST_TAGET_TYPE_VEHICLE									2
#define CONST_INTELLIGENCE_ANALYSE_UNIT_LEN					10		//智能分析能力单位长度
