...
public:
	...
	*		false：失败
	*功能：
	*    若输入p_pszScanName长度<=CONST_MAXLENGTH_PTZ_SCAN_NAME，返回true，并保存到m_szProtocolName;
	*	 若输入p_pszScanName为null或者其长度>CONST_MAXLENGTH_PTZ_SCAN_NAME，返回false
	************************************************************************/
	...
	*		false：不相等
	**功能：
	*		两个PTZScan类的对象，所有属性均相等，则说明这两个对象相等，返回true
	*		如果有一个属性不等，则返回false。
	*****************************************************************************/
