#ifndef _MOTIONDETECTIONEVENTV2_H_
#define _MOTIONDETECTIONEVENTV2_H_
...
#include "MotionDetectionParamV2.h"
...
class SN_DLL_API MotionDetectionEventV2
{
public:
	MotionDetectionEventV2();
	~MotionDetectionEventV2();

	//拷贝构造函数
	MotionDetectionEventV2 (const MotionDetectionEventV2 &p_objMotionDetectionEventV2);
...
public:
	...
	*      
	**************************************************************************/
	MotionDetectionParamV2* getMotionDetectionParam() const; 
	...
	*      
	**************************************************************************/
	void setMotionDetectionParam(MotionDetectionParamV2 &p_objMotionDetectionParamV2); 
	...
	*		赋值函数
	**输入：
	*		p_objMotionDetectionEventV2：移到侦测报警事件对象
	**输出：
	*		无
	**返回值：
	*		赋值后的移到侦测报警事件对象
	...
	*		
	*****************************************************************************/
	MotionDetectionEventV2& operator = (const MotionDetectionEventV2 &p_objMotionDetectionEventV2);
...
private:
	...
	MotionDetectionParamV2			m_objMotionDetectionParamV2;		//移动侦测规则对象
...
#endif //_MOTIONDETECTIONEVENTV2_H_
