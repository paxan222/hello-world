#ifndef _OBJLEFTABILITY_H_
#define _OBJLEFTABILITY_H_
...
class SN_DLL_API ObjLeftAbility
{
public:
	ObjLeftAbility();
	~ObjLeftAbility();
	ObjLeftAbility& operator=(const ObjLeftAbility& p_objObjLeftAbility);
    /***********************************************************************
	*	概述：设置提供物品遗留（ObjLeft）功能的智能库的ID
	*	输入：
	*		p_nLibId ：智能库ID
	*	输出：
	*		无
