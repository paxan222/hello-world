#ifndef _OBJECT_LEFT_REGION_PARAM_H
#define _OBJECT_LEFT_REGION_PARAM_H
...
//物品遗留参数
class SN_DLL_API ObjectLeftRegionParam
{
public:
	ObjectLeftRegionParam();
	~ObjectLeftRegionParam();

	ObjectLeftRegionParam(const ObjectLeftRegionParam& p_objObjectLeftRegionParam);
	ObjectLeftRegionParam& operator=(const ObjectLeftRegionParam& p_objObjectLeftRegionParam);
public:
