#ifndef _CONVERSEABILITY_H_
#define _CONVERSEABILITY_H_
...
class SN_DLL_API ConverseAbility
{
public:
	ConverseAbility();
	~ConverseAbility();
	ConverseAbility& operator=(const ConverseAbility& p_objConverseAbility);
    /***********************************************************************
	*	概述：设置提供翻转（Converse）功能的智能库的ID
	*	输入：
	*		p_nLibId ：智能库ID
	*	输出：
	*		无
	...
	*	概述：设置是否支持翻转角度的能力
	*	输入：
	*		p_bConverseAngleEnable ：是否支持该项能力
	*	输出：
	*		无
	*	返回值：
	*		无
	...
	*       输入为false : 不支持该项能力。
	************************************************************************/
	void setConverseAngleEnable(const bool p_bConverseAngleEnable);
	...
	*       无
	************************************************************************/
	const bool getConverseAngleEnable() const;

    /***********************************************************************
	*	概述：设置翻转角度值的最大值
	*	输入：
	*		p_fConverseAngleMax ：翻转角度值的最大值
	*	输出：
	*		无
	*	返回值：
	*		无
	...
	*       无
	************************************************************************/
	void setConverseAngleMax(const float p_fConverseAngleMax);
	...
	*       无
	************************************************************************/
	const float getConverseAngleMax() const;

    /***********************************************************************
	*	概述：设置翻转角度值的最小值
	*	输入：
	*		p_fConverseAngleMax ：翻转角度值的最小值
	*	输出：
	*		无
	*	返回值：
	*		无
	...
	*       无
	************************************************************************/
	void setConverseAngleMin(const float p_fConverseAngleMin);
	...
	*       无
	************************************************************************/
	const float getConverseAngleMin() const;

    /***********************************************************************
	*	概述：设置翻转角度值的单位
	*	输入：
	*		p_pConverseAngleUnit ：翻转角度值的单位
	*	输出：
	*		无
	*	返回值：
	*		无
	...
	*       无
	************************************************************************/
	bool setConverseAngleUnit(const char* p_pConverseAngleUnit);
	...
	*       无
	************************************************************************/
	const char* getConverseAngleUnit() const;
...
private:
	int m_nLibId;
	bool m_bConverseAngleEnable;
	float m_fConverseAngleMax;
	float m_fConverseAngleMin;
	...
	char m_pConverseAngleUnit[CONST_INTELLIGENCE_ANALYSE_UNIT_LEN + 1];
