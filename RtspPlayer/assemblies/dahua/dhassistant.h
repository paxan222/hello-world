...
enum 
{
	...
	EN_SMTP,						// SMTP bitwise£¬1£ºalarm send out text mail 2£ºAlarm send out image3:support HealthMail
	...
	EN_DHCP,						// DHCP	Bitwise 1£ºDHCP
	EN_UPNP,						// UPNP	Bitwise 1£ºUPNP
	EN_COMM_SNIFFER,				// COM sniffer  Bitwise £º1:CommATM
	EN_NET_SNIFFER,					// Network sniffer Bitwise : 1£ºNetSniffer
	EN_BURN,						// Burn function Bitwise 1£ºSearch burn status 
	EN_VIDEO_MATRIX,				// Video matrix Bitwise  1£ºSupport video matrix or not 2:Support SPOT video matrix or not
	...
	EN_IPV6,                        // backup IPV6 configuration, by bit£º1-IPV6 configuration
   	EN_SNMP,                        // SNMP
	...
	EN_DSP_ENCODE_CAP,				// F5 DSP
	EN_MULTICAST,                   // Support multicast sub stream port   
};
