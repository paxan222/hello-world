...
typedef enum _SDK_CONFIG_TYPE
{
	...
	E_SDK_CFG_OPERATORS,		//运营商，APN无线接入点，数字拨号配置--SDK_OperatorConfig
}SDK_CONFIG_TYPE;
...
enum
{
    ...
    SDK_MAX_DISK_PER_MACHINE = 16,		///< 最多支持8块硬盘
};
//硬盘管理
...
typedef struct SDK_OperatorConfig		//用于配置保存下拉框选项的值
{
	int OperatorsValue;		//运营商
	int APNValue;			//APN接入点名称
	int DialValue;			//拨号号码
}SDK_OperatorConfig;
