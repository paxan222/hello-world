...
private:
	...
	void WriteHeaderWithCallback(AVFormatContext *&outputFmtCtx);
	...
	void WritePacket(AVPacket packet, AVFormatContext *&outputFmtCtx, AVStream *inputStream, int outputStreamIndex);
